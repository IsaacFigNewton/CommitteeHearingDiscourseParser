...
| Experts' names are always mentioned before their first utterance and they will usually utter more than 3 sentences. | `NONLEGISLATOR` or `LEGISLATOR` | - | - | False | False | False | True | True | True | - | `Speaker.total_sentences`: `> 3` | `EXPERT` | - |

...
from src.grammar.Grammar import Rule, GRAMMAR
...
class MaskedSoftmaxHelper:
    ...
    def _allowed_sections_from_grammar_fallback(
        ...
        terminal_to_sections = cls._terminal_to_reachable_sections()
    ...
    @classmethod
    def _terminal_to_reachable_sections(cls) -> Dict[Any, Set[Any]]:
